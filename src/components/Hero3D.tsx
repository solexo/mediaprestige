  ...
  return (
    <section id="home" className="relative hero-section flex items-start md:items-center justify-center bg-black overflow-hidden pt-20 md:pt-0">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-orbitron font-bold mb-2 sm:mb-4 md:mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white via-gray-200 to-gray-400 animate-slow-pulse">
          {t('heroTitle')}
        </h1>
