...
export const categories: Category[] = [
  {
    ...
    nameFr: 'Hôtels',
    nameEn: 'Hotels',
    descriptionFr: 'Matériel audio professionnel pour hôtels et établissements d\'hébergement',
    descriptionEn: 'Professional audio equipment for hotels and accommodation establishments',
  ...
  },
  {
    ...
    nameFr: 'Villas',
    nameEn: 'Villas',
    descriptionFr: 'Matériel audio haut de gamme pour villas et résidences privées',
    descriptionEn: 'High-end audio equipment for villas and private residences',
  ...
  },
  {
    ...
    descriptionFr: 'Matériel audio professionnel pour salles de réunion et conférences',
  ...
  },
  {
    ...
    descriptionFr: 'Matériel audio pour restaurants, cafés et établissements de restauration',
    descriptionEn: 'Audio equipment for restaurants, cafes and food establishments',
  ...
  },
  {
    ...
    descriptionFr: 'Matériel audio pour showrooms, boutiques et espaces commerciaux',
    descriptionEn: 'Audio equipment for showrooms, shops and commercial spaces',
  ...
  },
  {
    ...
    nameEn: 'Guest Houses',
    descriptionFr: 'Matériel audio élégant pour maisons d\'hôtes et chambres d\'hôtes',
    descriptionEn: 'Elegant audio equipment for guest houses and bed & breakfasts',
  ...
  {
    id: 'outdoor-piscine',
    name: 'Outdoor Piscine',
    nameFr: 'Outdoor Piscine',
    nameEn: 'Outdoor Pool',
    descriptionFr: 'Matériel audio adapté pour espaces extérieurs et piscines',
    descriptionEn: 'Audio equipment adapted for outdoor spaces and pools',
    image: '/products/piscine.webp',
    suitableProducts: ['fs2se', '360p-ec', 'l1pro8'],
    features: ['Weather Resistant', 'Outdoor Entertainment', 'Pool Area Audio', 'Waterproof', 'Durable'],
    featuresFr: ['Résistant aux intempéries', 'Divertissement extérieur', 'Audio piscine', 'Étanche', 'Durable'],
    featuresEn: ['Weather Resistant', 'Outdoor Entertainment', 'Pool Area Audio', 'Waterproof', 'Durable']
  }
];