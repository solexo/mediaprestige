              ...
              <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50 hover:border-yellow-400/50 transition-all duration-300">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+212600051612" className="block text-gray-400 hover:text-yellow-400 transition-colors duration-300">+212 600 051 612</a>
                    <p className="text-gray-400"></p>
                    <a href="tel:+212522253434" className="block text-gray-400 hover:text-yellow-400 transition-colors duration-300">+212 522 253 434</a>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50 hover:border-yellow-400/50 transition-all duration-300">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="https://www.google.com/maps/place/M%C3%A9dia+Prestige/data=!4m2!3m1!1s0x0:0x28a8bc05bea361b9?sa=X&ved=1t:2428&ictx=111" target="_blank" rel="noopener noreferrer" className="block text-gray-400 hover:text-yellow-400 transition-colors duration-300">
