        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 mt-6 text-lg max-w-2xl mx-auto">
              {language === 'fr'
                ? 'Découvrez nos solutions audio adaptées à chaque environnement professionnel et résidentiel'
                : 'Discover our audio solutions tailored for every professional and residential environment'
              }
            </p>
          </div>
