...
const translations = {
  fr: {
    home: 'Accueil',
    products: 'Produits',
    categories: 'Experience Personnaliser',
    services: 'Services',
    ...
    aboutDesc: 'Media Prestige est un importateur et distributeur spécialisé dans le matériel de sonorisation et audiovisuel haut de gamme.',
  ...
  en: {
    home: 'Home',
    products: 'Products',
    categories: 'Personalized Experience',
    services: 'Services',
    solutions: 'Solutions',
